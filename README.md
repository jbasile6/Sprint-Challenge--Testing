...
`describe()` is used for breaking down test suites into different components whereas `it()` is used to when performing individual tests.

1. What is the point of `Test Driven Development`? What do you think about this approach?

TDD refers to the process of having requirements for a project put in as specific test cases. It ensures your code is doing what it is supposed to and catches bugs before they happen when code is being edited by you or a member of the team working on a project.
